...
CREATE TABLE `tb_dict` (
  ...
  `is_sys_default` INT(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` INT(5) COLLATE  utf8mb4_general_ci DEFAULT NULL,
  `order_no` INT(5) COLLATE  utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tb_dict_item` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `dict_id` INT(5) COLLATE  utf8mb4_general_ci DEFAULT NULL,
  `text` VARCHAR(200) CHARACTER SET utf8mb4 COLLATE  utf8mb4_general_ci DEFAULT NULL,
